...
export const PolicyCard = ({ title, id }: PolicyCardProps) => {
  ...
  return (
    <Card className="group bg-white border-gray-200 shadow-sm hover:shadow-md transition-all duration-300 flex flex-col h-[250px] relative overflow-hidden">
      ...
      <CardFooter className="justify-end mt-auto pt-4 border-t border-gray-100">
        <Link 
          to={`/policy/${id}`} 
